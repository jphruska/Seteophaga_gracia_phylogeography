...
## across five populations of setophaga graciae (Southwest_USA, Chihuahua, Durango, Guerrero, Chiapas, El Salvador + Honduras, and Nicaragua)
...
## Inspired by https://github.com/darreni/GW_genomics/blob/master/genomics_R_functions.R
...
## Read in Pi estimates (including all seven populations)
...
# produce plots of standardized pi correlations 
...
# Plot standardized pi for nicaragua 
...
# Plot standardized pi for el_salvador_honduras 
...
# Plot standardized pi for chiapas
...
# Plot standardized pi for guerrero
...
# Plot standardized pi for durango
...
# Plot standardized pi for chihuahua 
...
# Plot standardized pi for southwest_usa
...
# plot of relationship between correlations of standardized divergence and divergence times and delta_effective_population_sizes between population comparisons. 
...
# southwest_usa x el_salvador_honduras plot 
...
# southwest_usa x nicaragua plot 
...
# guerrero x el_salvador_honduras plot 
...
# el_salvador_honduras x chiapas plot 
...
# nicaragua x el_salvador_honduras plot 
