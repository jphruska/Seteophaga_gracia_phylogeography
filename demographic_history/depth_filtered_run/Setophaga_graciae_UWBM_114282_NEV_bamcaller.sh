...
samtools mpileup -q 20 -Q 20 -C 50 -u -r ${input} -f /lustre/scratch/johruska/central_america_pine_oak/setophaga_ref/GCA_001746935.2_mywa_2.1_genomic.fna /lustre/scratch/johruska/setophaga/01_bam_files/Setophaga_graciae_UWBM_114282_NEV_final.bam | bcftools call -c -V indels | bcftools view -i 'INFO/DP>9' | /lustre/work/johruska/msmc-tools/bamCaller.py ${depth} ./Setophaga_graciae_UWBM_114282_NEV/beds/${input}_mask.bed.gz | gzip -c > ./Setophaga_graciae_UWBM_114282_NEV/vcfs/${input}.vcf.gz
