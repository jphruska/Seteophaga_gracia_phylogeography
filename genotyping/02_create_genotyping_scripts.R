...
project_directory <- "/lustre/scratch/johruska/setophaga"
directory_name <- "11_setophaga_genotype"
reference_genome_location <- "/lustre/scratch/johruska/central_america_pine_oak/parulidae_ref/GCA_001746935.2_mywa_2.1_genomic.fna"
cluster <- "quanah"
output_name <- "setophaga_genotype"
popmap <- "setophaga_popmap.txt"
individuals <- read.table(popmap, sep="\t")
faidx <- read.table("GCA_001746935.2_mywa_2.1_genomic.fna.fai", stringsAsFactors=F)
singularity_cache <- "/lustre/work/johruska/singularity-cachedir"
