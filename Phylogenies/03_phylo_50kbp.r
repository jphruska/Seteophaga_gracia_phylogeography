options(scipen=999)
project_directory <- "/lustre/scratch/johruska/setophaga/03_vcf/combined_vcfs/dataset1_phylo"
...
header <- paste('\tgunzip -cd ', project_directory, '/CM027507.1.g.vcf.phylo.filtered.vcf.recode.vcf.gz | grep "#" > ', project_directory, "/windows/${chrom_array}__${start_array}__${end_array}.recode.vcf", sep="")
