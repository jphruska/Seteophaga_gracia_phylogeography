...
for (( run=$START_NUM; run<=$END_NUM; run++ )); do
	...
	Rscript calculate_windows.r /lustre/scratch/johruska/setophaga/03_vcf/combined_vcfs/dataset1_phylo/windows/${chrom_array}__${start_array}__${end_array}.simple.vcf popmap_phylo.txt
